...
SWIFT_CLASS("_TtC6Favorr6Favorr")
@interface Favorr : NSObject
@property (nonatomic, copy) NSString * _Nullable apiKey;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Favorr * _Nonnull sharedInstance;)
+ (Favorr * _Nonnull)sharedInstance;
- (void)initWithApiKeyWithApiKey:(NSString * _Nonnull)apiKey completion:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completion SWIFT_METHOD_FAMILY(none);
...
SWIFT_CLASS("_TtC6Favorr12FavorrAdView")
@interface FavorrAdView : UIView <SKStoreProductViewControllerDelegate>
...
@interface UIDevice (SWIFT_EXTENSION(Favorr))
